...
int readUDP(XPCSocket sock, char buffer[], int len)
{
	...
	// Set timeout period for select to 0.005 sec = 5 milliseconds = 5,000 microseconds (0 makes it polling)
	// A shorter timeout keeps the main simulation loop from stalling while waiting for X-Plane.
	timeout.tv_sec = 0;
